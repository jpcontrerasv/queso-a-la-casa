        ...
        switch ($item['zone_type']) {
            case 'everywhere':
                ...
                if( isset( $excluded ) && $excluded != '' ) {
                    $i = 0;
                    $return .= '<br /><br/><i>'.__('Except for','woocommerce').'...</i><br />';
            ...
            case 'countries':
                ...
                if( isset( $excluded ) && $excluded != '' ) {
                    $i = 0;
                    $cur_country = "";
                    $return_val .= '<br /><br/><i>'.__('Except for','woocommerce').'...</i><br />';
            ...
            case 'postal':
                ...
                if( isset( $excluded ) && $excluded != '' ) {
                    $i = 0;
                    $return .= '<br /><br/><i>'.__('Except for','woocommerce').'...</i><br />'.sanitize_text_field($item['zone_except']);
                }
                break;
            default:
    ...
    function tt_render_list_page(){
        ...
        <div class="wrap woocommerce">
            ...
            <div class="updated" style="font-weight:bold;">
                <p>Your zones have been updated. Please test your forms to ensure that everything is in working order.</p>
            </div>
            <?php endif; ?>
            ...
            <form id="zone-editor" method="post" action="">
                ...
                <tr valign="top">
                    ...
                    <td><select style="min-width:450px;" class="chosen_select" id="zone_type" name="zone_type">
                        ...
                        <option value="countries"<?php if ($zone_fields['zone_type'] == 'countries') echo " selected=selected"; ?>><?php echo __('Countries / States', 'woocommerce'); ?></option>
                ...
                <tr valign="top">
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc"><label><?php echo __('Except', 'woocommerce'); ?>...</label></th>
                        <td class="forminp">
                            <select multiple="multiple" name="location_everywhere_except[]" style="width:450px;" data-placeholder="<?php _e( 'Choose countries / states&hellip;', 'woocommerce' ); ?>" title="Country" class="chosen_select">
                                <?php
                ...
                <table id="location_countries" class="form-table" style="display:none">
                    <tr valign="top">
                        <th scope="row" class="titledesc"><label><?php echo __('Countries', 'woocommerce'); ?></label></th>
                        <td class="forminp">
                            <select multiple="multiple" name="location_countries[]" style="width:450px;" data-placeholder="<?php _e( 'Choose countries / states&hellip;', 'woocommerce' ); ?>" title="Country" class="chosen_select">
                                <?php
                                    if ( $allowed_countries ) {
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc"><label><?php echo __('Except the States/Provinces', 'woocommerce'); ?>...</label></th>
                        <td class="forminp">
                            <select multiple="multiple" name="location_countries_exceptS[]" style="width:450px;" data-placeholder="<?php _e( 'Choose countries / states&hellip;', 'woocommerce' ); ?>" title="Country" class="chosen_select">
                                <?php
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc"><label><?php echo __('Except the Postal Codes', 'woocommerce'); ?>...</label></th>
...
?>
                    ...
                    <tr valign="top">
                        ...
                        <td><textarea style="width:450px;height:75px" name="location_postal_except"><?php if(isset($zone_fields['zone_except'])) echo sanitize_text_field($zone_fields['zone_except']); ?></textarea><br ?>
                            <strong>-</strong> <small><?php _e('is used to separate two postal codes in a range (numerical codes ONLY)','woocommerce'); ?></small></br />
                            <strong>*</strong> <small><?php _e('is a wildcard used to representent multiple characters/numbers','woocommerce'); ?></small></br /></td>
                    </tr>
                </table>
...
function enable_zone_link() {
    ...
    if( array_key_exists($zoneID, $shipping_zones) ) {
        $zone_enabled = $shipping_zones[ $zoneID ]['zone_enabled'];//$wpdb->get_var("SELECT zone_enabled FROM ".$wpdb->prefix."woocommerce_shipping_zones WHERE zone_id='".$_GET['zone_id']."'");
